   ...
   <body>
      <section class="mt-3">
         ...
         <div class="row">
            ...
            <div class="col-md-7  mt-4" style="background-color:#f5f5f5;" id="print_section">
               <div class="p-4">
                  ...
                  <input type="button" class="btn btn-primary" onclick="printDivSection('print_section')" value="PRINT" />
                </div>
            </div>
         </div>
